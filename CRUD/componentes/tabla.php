...
<div class="row">
	<div class="col-sm-12">
	<h2 class="text-top">Crear, Leer, Actualizar, Borrar</h2>
		...
		<caption>
			...
			<tr>
				...
				<td>
		 			<button class="btn btn-danger glyphicon glyphicon-remove" onclick="confirmacion('<?php echo $ver[0] ?>')"></button>
				</td>
			</tr>
			<?php
		}
